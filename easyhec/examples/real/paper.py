...
paper_sizes = {
    ...
    "a4": {
        "width": 210.0,  # 8.27 inches in mm
        "height": 297.0,  # 11.69 inches in mm
    },
}
...
def main(args: RealPaperArgs):
    ...
    paper_width = 0.210  # 210mm
    paper_height = 0.297  # 297mm
    paper_thickness = 0.001  # 1mm thick
    paper_box = trimesh.creation.box(
        extents=(paper_width, paper_height, paper_thickness)
    )
    meshes = [paper_box]
